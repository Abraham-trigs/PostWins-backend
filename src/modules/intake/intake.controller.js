...
exports.handleIntake =
  exports.handleIntakeFollowup =
  exports.handleIntakeDelivery =
    void 0;
...
const intakeService = new intake_service_1.IntakeService(
  integrityService,
  taskService,
);
...
const handleIntakeDelivery = async (req, res) => {
  try {
    ...
    await (0, idempotency_middleware_1.commitIdempotencyResponse)(
      res,
      responsePayload,
    );
